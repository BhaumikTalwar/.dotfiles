...
globalkeys = awful.util.table.join(
	...
	awful.key({ modkey }, "p", function()
		awful.util.spawn(terminal .. " -e pamix")
	end),
	awful.key({ modkey }, "w", function()
		awful.util.spawn(terminal .. "sudo -e wifi-menu")
	end),
	...
	awful.key({ altkey }, "i", function()
		awful.util.spawn("insync start")
	end),
	awful.key({ altkey }, "r", function()
		awful.util.spawn("polychromatic-tray-applet")
	end),
	awful.key({ altkey }, "p", function()
		awful.util.spawn("/opt/piavpn/bin/pia-client")
	end),
	awful.key({ altkey, "Shift" }, "p", function()
		awful.util.spawn("pkill /opt/piavpn/bin/pia-client")
	end),
	...
	-- Conky HUD
	awful.key({ altkey }, "z", function()
		awful.util.spawn("sh /home/msjche/.config/awesome/conky_launch.sh")
	end),
	...
	awful.key({ modkey, "Control" }, "Delete", function()
		awful.util.spawn("/home/msjche/.local/bin/lock")
	end),
